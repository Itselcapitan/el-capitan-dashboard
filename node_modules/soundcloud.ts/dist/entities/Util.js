    ...
    function Util(api) {
        ...
        this.downloadTrack = function (trackResolvable_1, dest_1) {
            ...
            return __awaiter(_this, __spreadArray([trackResolvable_1, dest_1], args_1, true), void 0, function (trackResolvable, dest, metadata) {
                var folder, track, output, downloadObj, result, arrayBuffer, _a, coverLink, imageBuffer, buffer, writer, taggedBuffer;
                var _b;
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            track = _c.sent();
                            output = "";
                            if (!(track.downloadable === true)) return [3 /*break*/, 9];
                            _c.label = 2;
                        case 2:
                            _c.trys.push([2, 6, , 8]);
                        ...
                        case 6:
                            _a = _c.sent();
                            return [4 /*yield*/, this.downloadTrackStream(track, track.title.replace(/[\\/:*?\"<>|]/g, ""), dest)];
                        case 7:
                            output = _c.sent();
                            return [3 /*break*/, 8];
                        case 8: return [3 /*break*/, 11];
                        case 9: return [4 /*yield*/, this.downloadTrackStream(track, track.title.replace(/[\\/:*?\"<>|]/g, ""), dest)];
                        case 10:
                            output = _c.sent();
                            _c.label = 11;
                        case 11:
                            if (!metadata) return [3 /*break*/, 15];
                            return [4 /*yield*/, this.downloadSongCover(track, "", true)];
                        case 12:
                            coverLink = _c.sent();
                            return [4 /*yield*/, fetch(coverLink).then(function (r) { return r.arrayBuffer(); })];
                        case 13:
                            imageBuffer = _c.sent();
                            buffer = new Uint8Array(fs.readFileSync(output)).buffer;
                            ...
                            writer.setFrame("TIT2", track.title)
                                ...
                                text: (_b = track.description) !== null && _b !== void 0 ? _b : "",
                                language: "eng"
                            })
                                .setFrame("APIC", {
                                type: 3,
